(ns atc-support.advisor
  "ATCSupportAdvisor — proposes an ATC support action
  (log shift handover, draft training record, flag equipment anomaly,
  coordinate facility maintenance) for a registered controller/facility. The advisor
  ...
  notion of controller/facility provenance or operational authority; `atc-support.governor`
  is the independent system that decides whether the proposal may proceed, per
  the itonami actor pattern.

  A proposal is a map:
    {:op :log-shift-handover-note|:draft-training-record|:flag-equipment-anomaly|:coordinate-facility-maintenance
...
(def ^:private system-prompt
  "You are an ATC administrative support advisor. Given an ATC support
   request (shift handover note, training record, equipment anomaly flag,
   facility maintenance coordination), propose an :op, an honest :confidence (0.0-1.0),
   ...
   clearances, separation, real-time control, or operational decisions.
   Your role is ground-based documentation and facility management support.")
